...
4. Keep source files as nodes. Directory and package groups organize local files. External packages and Node.js built-ins remain boundary nodes; never expand their internals.
