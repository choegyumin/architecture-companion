...
import {
  groupRowsDiagramLayoutConfigSchema,
  layoutGroupRowsDiagram,
} from "@/features/diagram/_layout/group-rows-diagram-layout.prototype";
...
export function layoutDiagram(
  ...
  switch (diagram.layout.id) {
    ...
    case "prototype-group-rows":
      return layoutGroupRowsDiagram(diagram.graph, nodeSizes);
    case "sequence":
