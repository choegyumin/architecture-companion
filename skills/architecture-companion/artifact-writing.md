...
- Record the chosen logical generator ID as `generator` on every diagram you create or regenerate. Reading the artifact must not require that generator to be installed.
